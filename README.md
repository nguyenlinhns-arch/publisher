...
- Dùng `assets/nen.png` làm nền tin tức xanh đen mặc định, có ánh cam và viền
  khung cyan tinh tế; tệp nền không chứa chữ, logo hay giao diện mạng xã hội.
- Đặt video ngang trong vùng trống phía trên; tiêu đề và thương hiệu nằm trong
  khung viền phía dưới.
