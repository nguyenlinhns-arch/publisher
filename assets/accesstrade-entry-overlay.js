(function(){
  ...
  function init(){
    ...
    style.textContent=''
      ...
      +'.at-offer-cta{min-height:44px;min-width:132px;padding:0 15px;border-radius:12px;display:flex;align-items:center;justify-content:center;background:#b33a20;color:#fff!important;text-decoration:none;font-size:12px;font-weight:900;white-space:nowrap}'
